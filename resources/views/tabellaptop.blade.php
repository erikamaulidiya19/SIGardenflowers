...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      <!--Favicon-->
  <link rel="shortcut icon" href="{!! asset('asset/images/com.jpg') !!}" type="image/x-icon">
  <link rel="icon" href="{!! asset('asset/images/com.jpg') !!}" type="image/x-icon">
...
<body>
    <header class="navigation">
        <nav class="navbar navbar-expand-lg navbar-light">
          <a class="navbar-brand" href="/index"><img class="img-fluid" src="{!! asset('asset/images/com.jpg') !!}" style="width:10em;" alt="parsa"></a>
          ...
          <div class="collapse navbar-collapse text-center" id="navogation">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link text-uppercase text-dark" href="/laptop">Back</a>
              </li>
              <li class="nav-item">
						...
						<table>
							<thead>
								<tr class="row100 head">
                                    ...
                                    <th class="cell100 column3">Alamat Toko Laptop</th>
								</tr>
							</thead>
						</table>
					</div>
                            ...
                            @endphp
                             @foreach ($data as $item)
								<tr class="row100 body">
									...
									<td class="cell100 column4">{{$item->alamatlaptop}}</td>
