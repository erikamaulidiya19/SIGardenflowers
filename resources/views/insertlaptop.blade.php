        ...
        <div class="main-panel">
            ...
            <form action="/datalaptop" class="signin-form" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="namalaptop" name="namalaptop" required value="{{ old('namalaptop') }}">
                </div>
                <div class="mb-3">
                  <label for="tokolaptop" class="form-label">Nama Toko Laptop</label>
                  <input type="text" class="form-control" id="tokolaptop" name="tokolaptop"required value="{{ old('tokolaptop') }}">
                </div>
                <div class="mb-3">
