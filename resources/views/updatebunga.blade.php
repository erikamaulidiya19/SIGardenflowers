        ...
        <div class="main-panel">
            ...
            <form action="/databunga" class="signin-form" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="namabunga" name="namabunga" required value="{{ $data->namabunga }}">
                </div>
                <div class="mb-3">
                  <label for="tokobunga" class="form-label">Nama Toko Bunga</label>
                  <input type="text" class="form-control" id="tokobunga" name="tokobunga"required value="{{ $data->tokobunga}}">
                </div>
