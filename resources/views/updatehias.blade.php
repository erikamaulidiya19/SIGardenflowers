    ...
    -->
        ...
        <div class="main-panel">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">Update Data Hias</h4>
            ...
            <form action="/datatanaman" class="signin-form" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control" id="id_hias" name="id_hias" required value="{{ $data->id_hias }}">

                <div class="mb-3">
                  <label for="namahias" class="form-label">Nama Tanaman Hias</label>
                  <input type="text" class="form-control" id="namahias" name="namahias" required value="{{ $data->namahias }}">
                </div>
                <div class="mb-3">
                  <label for="tokohias" class="form-label">Nama Toko Tanaman Hias</label>
                  <input type="text" class="form-control" id="tokohias" name="tokohias"required value="{{ $data->tokohias}}">
                </div>

                <div class="mb-3">
                    <label for="hargahias" class="form-label">Harga</label>
                    <input type="text" class="form-control" id="hargahias" name="hargahias"required value="{{ $data->hargahias}}">
                  </div>

                <div class="mb-3">
                    <label for="alamathias" class="form-label">Alamat Toko Tanaman Hias</label>
                    <input type="text" class="form-control" id="alamathias" name="alamathias"required value="{{ $data->alamathias }}">
                  </div>
